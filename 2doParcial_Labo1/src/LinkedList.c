...
int ll_sort(LinkedList* this, int (*pFunc)(void* ,void*), int order)
{
    ...
    if(this != NULL && (order == 0 || order == 1) && pFunc != NULL)
    {
    	...
    	do
    	{
    		...
    		for(int i = 0; i < len; i++)
    		{
    			auxElementUno = ll_get(this, i);
    			auxElementDos = ll_get(this, i+1);

    			if((order == 1 && pFunc(auxElementUno, auxElementDos) > 0) ||
    					(order == 0 && pFunc(auxElementUno, auxElementDos) < 0))
    			{
					ll_set(this, i, auxElementDos);
					ll_set(this, i+1, auxElementUno);
					estaOrdenado = 0;
    			}
    		}
